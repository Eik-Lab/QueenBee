...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  const idOptions = ids.map((_id: any) => { return { value: _id, label: _id } })
    ...
    <Layout title="BeeCTRL">
      ...
      <div className=" bg-gray-300 mt-4 p-4 rounded-2xl">
        ...
        <p className="italic pointer-events-none md:text-base text-sm">
          The bees are important. Unfortunately, taking care of a bee hive is a time-intensive process.
          Thus, we attempt to make the process less time-consuming by developing Bee CTRL.
          An Open-source monitoring- and alerting system which can be installed in a bee hive. {' '}
          <a href="https://github.com/Eik-Lab/Bee-CTRL" target="_blank" className="text-blue-600 text-xs md:text-sm pointer-events-auto">Read more at GitHub</a>
        </p>
      </div>
